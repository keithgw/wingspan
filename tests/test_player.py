...
class TestPlayer(unittest.TestCase):
    ...
    @patch.object(Player, 'choose_action', return_value='play_a_bird')
    ...
    def test_enumerate_legal_actions(self):
        legal_actions = self.player.enumerate_legal_actions(self.tray, self.bird_deck)
        ...
        empty_deck = Deck()
        legal_actions = self.player.enumerate_legal_actions(self.tray, empty_deck)
        self.assertIn('draw_a_bird', legal_actions)
        ...
        empty_tray = Tray()
        legal_actions = self.player.enumerate_legal_actions(empty_tray, empty_deck)
    ...
    def test_choose_action(self, input):
        ...
        action = self.player.choose_action(self.tray, self.bird_deck)
        self.assertEqual(action, 'play_a_bird')
